Shader "Hidden/Locked/.poiyomi/Poiyomi Toon + Lil Fur/8b37dcfe13b269e40a0c987ac8809d65"
{
	Properties
	{
		...
		[HideInInspector] m_lilFurCategory ("lil Fur--{button_author:{text:lilxyzw,action:{type:URL,data:https://github.com/lilxyzw/lilToon},hover:GitHub},button_help:{text:Tutorial,action:{type:URL,data:https://www.poiyomi.com/extended-features/lilfur},hover:Documentation}}", Float) = 0
		[ThryWideEnum(Cutout, 0, Transparent, 1)]_FurRenderingMode ("Fur Mode--{on_value_actions:[
		{value:0,actions:[{type:SET_PROPERTY,data:_FurSrcBlend=1}, {type:SET_PROPERTY,data:_FurDstBlend=0}, {type:SET_PROPERTY,data:_FurSrcBlendAlpha=1}, {type:SET_PROPERTY,data:_FurDstBlendAlpha=10}, {type:SET_PROPERTY,data:_FurBlendOp=0}, {type:SET_PROPERTY,data:_FurBlendOpAlpha=0}, {type:SET_PROPERTY,data:_FurSrcBlendFA=1}, {type:SET_PROPERTY,data:_FurDstBlendFA=1}, {type:SET_PROPERTY,data:_FurSrcBlendAlphaFA=0}, {type:SET_PROPERTY,data:_FurDstBlendAlphaFA=1}, {type:SET_PROPERTY,data:_FurBlendOpFA=4}, {type:SET_PROPERTY,data:_FurBlendOpAlphaFA=4}, {type:SET_PROPERTY,data:_FurZWrite=1}, {type:SET_PROPERTY,data:_FurAlphaToMask=1}, {type:SET_TAG,data:RenderType=TransparentCutout}, {type:SET_TAG,data:Queue=AlphaTest}]},
		{value:1,actions:[{type:SET_PROPERTY,data:_FurSrcBlend=5}, {type:SET_PROPERTY,data:_FurDstBlend=10}, {type:SET_PROPERTY,data:_FurSrcBlendAlpha=1}, {type:SET_PROPERTY,data:_FurDstBlendAlpha=10}, {type:SET_PROPERTY,data:_FurBlendOp=0}, {type:SET_PROPERTY,data:_FurBlendOpAlpha=0}, {type:SET_PROPERTY,data:_FurSrcBlendFA=1}, {type:SET_PROPERTY,data:_FurDstBlendFA=1}, {type:SET_PROPERTY,data:_FurSrcBlendAlphaFA=0}, {type:SET_PROPERTY,data:_FurDstBlendAlphaFA=1}, {type:SET_PROPERTY,data:_FurBlendOpFA=4}, {type:SET_PROPERTY,data:_FurBlendOpAlphaFA=4}, {type:SET_PROPERTY,data:_FurZWrite=0}, {type:SET_PROPERTY,data:_FurAlphaToMask=0}, {type:SET_TAG,data:RenderType=TransparentCutout}, {type:SET_TAG,data:Queue=Transparent}]}
		]}]}", Int) = 0
		[HideInInspector] s_start_FurVector ("Fur", Float) = 1
		[TextureKeyword][NoScaleOffset][Normal] _FurVectorTex ("Normal Map--{reference_property:_FurVectorScale}", 2D) = "bump" { }
		[HideInInspector] _FurVectorScale ("Vector scale", Range(-10, 10)) = 1
		[TextureKeyword][NoScaleOffset] _FurLengthMask ("Length Mask", 2D) = "white" { }
		[Vector3Slider(0, 0.5, 1)] _FurVector ("Vector|Length", Vector) = (0.0, 0.0, 1.0, 0.02)
		[ToggleUI] _VertexColor2FurVector ("VertexColor -> Vector", Int) = 0
		_FurGravity ("Gravity", Range(0, 1)) = 0.25
		_FurRandomize ("Randomize", Float) = 0
		[HideInInspector] s_end_FurVector ("Vector", Float) = 1
		[HideInInspector] s_start_FurAppearance ("Appearance", Float) = 1
		[TextureKeyword][ThryForceTexOpen] _FurNoiseMask ("Noise", 2D) = "white" { }
		[TextureKeyword][NoScaleOffset] _FurMask ("Alpha Mask", 2D) = "white" { }
		_FurAO ("AO", Range(0, 1)) = 0
		[HideInInspector] s_end_FurAppearance ("Appearance", Float) = 1
		[HideInInspector] s_start_FurLayers ("Layers", Float) = 1
		[IntRange] _FurLayerNum ("Layer Counts", Range(1, 3)) = 2
		[InvertedSlider]_FurRootOffset ("Root Width", Range(0, 1)) = 0
		_FurTouchStrength ("Touch strength", Range(0, 1)) = 0
		[HideInInspector] s_end_FurLayers ("Layers", Float) = 1
		[HideInInspector] s_start_FurRimLight ("Rim Light", Float) = 1
		_FurRimColor ("Color", Color) = (0.0, 0.0, 0.0, 1.0)
		[PowerSlider(3.0)]_FurRimFresnelPower ("Fresnel Power", Range(0.01, 50)) = 3.0
		_FurRimAntiLight ("Anti Light", Range(0, 1)) = 0.5
		[HideInInspector] s_end_FurRimLight ("Rim Light", Float) = 1
		[HideInInspector] s_start_LilFurRendering ("Rendering--{button_help:{text:Tutorial,action:{type:URL,data:https://www.poiyomi.com},hover:Documentation}}", Float) = 0
		[Enum(UnityEngine.Rendering.CullMode)] _FurCull ("Cull", Float) = 0
		[Enum(UnityEngine.Rendering.BlendMode)] _FurSrcBlend ("SrcBlend RGB", Float) = 1
		[Enum(UnityEngine.Rendering.BlendMode)] _FurDstBlend ("DstBlend RGB", Float) = 0
		[Enum(UnityEngine.Rendering.BlendMode)] _FurSrcBlendAlpha ("SrcBlend Alpha", Float) = 1
		[Enum(UnityEngine.Rendering.BlendMode)] _FurDstBlendAlpha ("DstBlend Alpha", Float) = 10
		[Enum(UnityEngine.Rendering.BlendOp)] _FurBlendOp ("BlendOp RGB", Float) = 0
		[Enum(UnityEngine.Rendering.BlendOp)] _FurBlendOpAlpha ("BlendOp Alpha", Float) = 0
		[Space(10)]
		[ThryHeaderLabel(Forward Add, 13)]
		[Enum(UnityEngine.Rendering.BlendMode)] _FurSrcBlendFA ("SrcBlend RGB", Float) = 1
		[Enum(UnityEngine.Rendering.BlendMode)] _FurDstBlendFA ("DstBlend RGB", Float) = 1
		[Enum(UnityEngine.Rendering.BlendMode)] _FurSrcBlendAlphaFA ("SrcBlend Alpha", Float) = 0
		[Enum(UnityEngine.Rendering.BlendMode)] _FurDstBlendAlphaFA ("DstBlend Alpha", Float) = 1
		[Enum(UnityEngine.Rendering.BlendOp)] _FurBlendOpFA ("BlendOp RGB", Float) = 4
		[Enum(UnityEngine.Rendering.BlendOp)] _FurBlendOpAlphaFA ("BlendOp Alpha", Float) = 4
		[Space(10)]
		[ToggleUI] _FurZClip ("ZClip", Float) = 1
		[ToggleUI] _FurZWrite ("ZWrite", Float) = 1
		[Enum(UnityEngine.Rendering.CompareFunction)] _FurZTest ("ZTest", Float) = 4
		_FurOffsetFactor ("Offset Factor", Float) = 0
		_FurOffsetUnits ("Offset Units", Float) = 0
		[Enum(None, 0, R, 8, G, 4, B, 2, A, 1, RGB, 14, RGBA, 15)] _FurColorMask ("Color Mask", Float) = 15
		[ToggleUI] _FurAlphaToMask ("Alpha To Mask", Float) = 1
		[HideInInspector] s_end_LilFurRendering ("Rendering", Float) = 0
		[HideInInspector] s_start_LilFurStencil ("Stencil--{button_help:{text:Tutorial,action:{type:URL,data:https://www.poiyomi.com/rendering/stencil},hover:Documentation}}", Float) = 0
		[ThryWideEnum(Simple, 0, Front Face vs Back Face, 1)] _FurStencilType ("Stencil Type", Float) = 0
		...
		[Enum(UnityEngine.Rendering.StencilOp)] _FurStencilPass ("Stencil Pass Op--{condition_showS:(_FurStencilType==0)}", Float) = 0
		[Enum(UnityEngine.Rendering.StencilOp)] _FurStencilFail ("Stencil Fail Op--{condition_showS:(_FurStencilType==0)}", Float) = 0
		[Enum(UnityEngine.Rendering.StencilOp)] _FurStencilZFail ("Stencil ZFail Op--{condition_showS:(_FurStencilType==0)}", Float) = 0
		[Enum(UnityEngine.Rendering.CompareFunction)] _FurStencilComp ("Stencil Compare Function--{condition_showS:(_FurStencilType==0)}", Float) = 8
		[HideInInspector] s_start_LilFurStencilBack ("Back--{condition_showS:(_FurStencilType==1),margin_top:0,border_top:0,border_bottom:0,border_width_bottom:0}", Float) = 1
		[Helpbox(1)] _FurFFBFStencilHelp0 ("Front Face and Back Face Stencils only work when locked in due to Unity's Stencil managment", Int) = 0
		[Enum(UnityEngine.Rendering.StencilOp)] _FurStencilBackPass ("Back Pass Op", Float) = 0
		[Enum(UnityEngine.Rendering.StencilOp)] _FurStencilBackFail ("Back Fail Op", Float) = 0
		[Enum(UnityEngine.Rendering.StencilOp)] _FurStencilBackZFail ("Back ZFail Op", Float) = 0
		[Enum(UnityEngine.Rendering.CompareFunction)] _FurStencilBackComp ("Back Compare Function", Float) = 8
		[HideInInspector] s_end_LilFurStencilBack ("Back", Float) = 0
		[HideInInspector] s_start_LilFurStencilFront ("Front--{condition_showS:(_FurStencilType==1),margin_top:0,border_top:0,border_bottom:0}", Float) = 1
		[Helpbox(1)] _FurFFBFStencilHelp1 ("Front Face and Back Face Stencils only work when locked in due to Unity's Stencil managment", Int) = 0
		[Enum(UnityEngine.Rendering.StencilOp)] _FurStencilFrontPass ("Front Pass Op", Float) = 0
		[Enum(UnityEngine.Rendering.StencilOp)] _FurStencilFrontFail ("Front Fail Op", Float) = 0
		[Enum(UnityEngine.Rendering.StencilOp)] _FurStencilFrontZFail ("Front ZFail Op", Float) = 0
		[Enum(UnityEngine.Rendering.CompareFunction)] _FurStencilFrontComp ("Front Compare Function", Float) = 8
		[HideInInspector] s_end_LilFurStencilFront ("Front", Float) = 0
		[HideInInspector] s_end_LilFurStencil ("Stencil", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			float _FurStencilBackComp;
			float _FurStencilBackPass;
			float _FurStencilBackFail;
			float _FurStencilBackZFail;
			float _FurStencilFrontComp;
			float _FurStencilFrontPass;
			float _FurStencilFrontFail;
			float _FurStencilFrontZFail;
			#ifdef POI_PASS_LILFUR
			...
			#ifdef POI_PASS_LILFUR
			struct PoiVertToGeoLilFur
			{
				float4 uv[2] : TEXCOORD0;
				float3 worldPos : TEXCOORD2;
				float3 normal : TEXCOORD3;
				uint vertexId : TEXCOORD4;
				float3 furVector : TEXCOORD5;
				float2 fogData : TEXCOORD6;
				UNITY_VERTEX_INPUT_INSTANCE_ID
				UNITY_VERTEX_OUTPUT_STEREO
			};
			struct PoiGeoToFragLilFur
			{
				float4 pos : SV_POSITION;
				float4 uv[2] : TEXCOORD0;
				float3 worldPos : TEXCOORD2;
			...
			VertexOut vert(appdata v)
			{
				...
				float4 outlineMaskTex = _OutlineMask.SampleLevel(sampler_linear_repeat, poiUV(vertexUV(v, _OutlineMaskUV), _OutlineMask_ST) + _Time.x * _OutlineMaskPan, 0);
			...
			void applyFurAOSimple(inout PoiFragData poiFragData, in PoiMesh poiMesh)
			{
				float mask = 1.0;
				#if defined(PROP_FURMASK) || !defined(OPTIMIZER_ENABLED)
				mask = _FurMask.Sample(sampler_linear_repeat, poiMesh.uv[0]).r;
				#endif
				poiFragData.baseColor *= (1.0 - _FurAO * mask);
			}
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				if(_FurRenderingMode == 0)
				{
					applyFurAOSimple(poiFragData, poiMesh);
				}
		...
		Pass
		{
			...
			void applyOutlineColor(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiMods poiMods, in PoiCam poiCam)
			{
				...
				#if defined(PROP_OUTLINEMASK) || !defined(OPTIMIZER_ENABLED)
				float OutlineMask = _OutlineMask.SampleLevel(sampler_linear_repeat, TRANSFORM_TEX(poiMesh.uv[_OutlineMaskUV], _OutlineMask) + _Time.x * _OutlineMaskPan, 0)[_OutlineMaskChannel];
				#else
				float OutlineMask = 1;
				#endif
				if (_OutlineVertexColorMask > 0)
		...
		Pass
		{
			...
			PoiVertToGeoLilFur vert(appdata v)
			{
				UNITY_SETUP_INSTANCE_ID(v);
				...
				#endif
				v.vertex.rgb += localOffset;
				o.worldPos.rgb += worldOffset;
				float4 clipPos = UnityObjectToClipPos(v.vertex);
				o.fogData.x = clipPos.z; // Store clip-space Z for fog calculations
				#ifdef FOG_EXP2
				o.fogData.y = 1;
				#else
				o.fogData.y = 0;
				...
				if(_VertexColor2FurVector) o.furVector = float3(o.furVector.xy + (v.color.xyz * 2.0 - 1.0).xy, o.furVector.z * (v.color.xyz * 2.0 - 1.0).z);
				#if defined(PROP_FURVECTORTEX) || !defined(OPTIMIZER_ENABLED)
				float2 uvMain = v.uv0.xy * _MainTex_ST.xy + _MainTex_ST.zw;
				float3 furVectorTex = UnpackScaleNormal(_FurVectorTex.SampleLevel(sampler_linear_repeat, uvMain, 0), _FurVectorScale);
			...
			float3 applyFurAO(float3 color, float furLayer, float furNoiseMask, float furLayerGradient)
			{
				#if defined(LIL_FUR_PRE)
				float furAO = _FurAO * saturate(1.0 - furLayerGradient);
				return color * (furLayer * furAO * 2.0 + 1.0 - furAO);
				#else
				if (_FurRenderingMode == 0)
				{
					float furAO = _FurAO * saturate(1.0 - furLayerGradient);
				...
				{
					return color * (saturate(1.0 - furNoiseMask + furNoiseMask * furLayer) * _FurAO * 1.25 + 1.0 - _FurAO);
				}
				#endif
			}
			void lilFur(inout PoiFragData poiFragData, PoiGeoToFragLilFur i, float4 mainTex)
			{
				poiFragData.baseColor = mainTex.rgb * _Color.rgb;
				float furLayer = i.furLayer;
				...
				#if defined(PROP_FURNOISEMASK) || !defined(OPTIMIZER_ENABLED)
				furNoiseMask = _FurNoiseMask.Sample(sampler_linear_repeat, i.uv[0].xy * _FurNoiseMask_ST.xy + _FurNoiseMask_ST.zw).r;
				#endif
				#if defined(LIL_FUR_PRE)
				...
				if (_FurRenderingMode == 0)
				{
					furAlpha = saturate(furNoiseMask - furLayerShift * furLayerAbs * furLayerAbs * furLayerAbs + 0.25);
				}
				else
				{
					furAlpha = saturate(furNoiseMask - furLayerShift * furLayerAbs * furLayerAbs);
				}
				#endif
				#if defined(PROP_FURMASK) || !defined(OPTIMIZER_ENABLED)
				furAlpha *= _FurMask.Sample(sampler_linear_repeat, i.uv[0].xy).r;
				#endif
				poiFragData.alpha = mainTex.a * _Color.a * furAlpha;
				float furLayerGradient = fwidth(i.furLayer);
				poiFragData.baseColor = applyFurAO(poiFragData.baseColor, furLayer, furNoiseMask, furLayerGradient);
			}
			#ifdef VIGNETTE_MASKED
			float GetRemapMinValue(float scale, float offset)
			{
			...
			#endif
			void applyReducedRenderClipDistanceGeoFur(inout float4 pos)
			{
			}
			float lilLerpFloat(float a, float b, float c, float3 factor)
			{
				return a * factor.x + b * factor.y + c * factor.z;
			}
			float2 lilLerpFloat2(float2 a, float2 b, float2 c, float3 factor)
			{
				return a * factor.x + b * factor.y + c * factor.z;
			}
			float3 lilLerpFloat3(float3 a, float3 b, float3 c, float3 factor)
			{
				return a * factor.x + b * factor.y + c * factor.z;
			}
			float4 lilLerpFloat4(float4 a, float4 b, float4 c, float3 factor)
			{
				return a * factor.x + b * factor.y + c * factor.z;
			}
			float lilLerpMask(float a, float b, float c, float3 factor)
			{
				return a * factor.x + b * factor.y + c * factor.z;
			}
			PoiGeoToFragLilFur SetupFurOutputStructs(inout PoiGeoToFragLilFur output, PoiVertToGeoLilFur input[3], float3 furVectors[3], float3 factor)
			{
				output.uv[0] = lilLerpFloat4(input[0].uv[0], input[1].uv[0], input[2].uv[0], factor);
				output.uv[1] = lilLerpFloat4(input[0].uv[1], input[1].uv[1], input[2].uv[1], factor);
				output.normal = lilLerpFloat3(input[0].normal, input[1].normal, input[2].normal, factor);
				output.vertexId = input[0].vertexId;
				output.fogData.x = lilLerpFloat(input[0].fogData.x, input[1].fogData.x, input[2].fogData.x, factor);
				output.fogData.y = input[0].fogData.y; // Fog type is same for all vertices
				float3 posWS = lilLerpFloat3(input[0].worldPos, input[1].worldPos, input[2].worldPos, factor);
				output.worldPos = posWS;
				output.pos = UnityWorldToClipPos(posWS);
				output.furLayer = 0;
				applyReducedRenderClipDistanceGeoFur(output.pos);
				#ifdef LIL_FUR_PRE
				#if defined(UNITY_REVERSED_Z)
				...
				#endif
				#endif
				PoiGeoToFragLilFur baseStruct = output;
				float3 furVec = lilLerpFloat3(furVectors[0], furVectors[1], furVectors[2], factor);
				posWS += furVec;
				output.worldPos = posWS;
				output.pos = UnityWorldToClipPos(posWS);
				output.furLayer = 1;
			...
			[maxvertexcount(40)]
			void geom(triangle PoiVertToGeoLilFur input[3], inout TriangleStream<PoiGeoToFragLilFur> outStream)
			{
				UNITY_SETUP_STEREO_EYE_INDEX_POST_VERTEX(input[0]);
				UNITY_SETUP_STEREO_EYE_INDEX_POST_VERTEX(input[1]);
				UNITY_SETUP_STEREO_EYE_INDEX_POST_VERTEX(input[2]);
				PoiGeoToFragLilFur output;
				...
				#if defined(PROP_FURLENGTHMASK) || !defined(OPTIMIZER_ENABLED)
				float2 lmUV0 = input[0].uv[0].xy * _MainTex_ST.xy + _MainTex_ST.zw;
				float2 lmUV1 = input[1].uv[0].xy * _MainTex_ST.xy + _MainTex_ST.zw;
				float2 lmUV2 = input[2].uv[0].xy * _MainTex_ST.xy + _MainTex_ST.zw;
				float lenMask0 = _FurLengthMask.SampleLevel(sampler_linear_repeat, lmUV0, 0).r;
				float lenMask1 = _FurLengthMask.SampleLevel(sampler_linear_repeat, lmUV1, 0).r;
				float lenMask2 = _FurLengthMask.SampleLevel(sampler_linear_repeat, lmUV2, 0).r;
				furVectors[0] *= lenMask0;
				furVectors[1] *= lenMask1;
				furVectors[2] *= lenMask2;
				#endif
				if (_FurLayerNum == 1)
				{
			...
			float4 frag(PoiGeoToFragLilFur i, uint facing : SV_IsFrontFace) : SV_Target
			{
				UNITY_SETUP_INSTANCE_ID(i);
				UNITY_SETUP_STEREO_EYE_INDEX_POST_VERTEX(i);
				float4 mainTexture = POI2D_SAMPLER_PAN(_MainTex, _MainTex, i.uv[0].xy * _MainTex_ST.xy + _MainTex_ST.zw, 0);
				PoiSHAr = unity_SHAr;
				PoiSHAg = unity_SHAg;
				PoiSHAb = unity_SHAb;
				PoiSHBr = unity_SHBr;
				...
				poiCam.worldPos = _WorldSpaceCameraPos;
				poiCam.vDotN = abs(dot(poiCam.viewDir, i.normal));
				if (_UdonForceSceneLighting)
				{
					_LightingMinLightBrightness = 0;
					_LightingCapEnabled = 0;
				...
				applyAlphaOptions(poiFragData, poiMesh, poiCam, poiMods);
				lilFur(poiFragData, i, mainTexture);
				#if defined(_LIGHTINGMODE_SHADEMAP) && defined(VIGNETTE_MASKED)
				#ifndef POI_PASS_OUTLINE
				#endif
				#endif
				...
				poiFragData.finalColor = poiFragData.baseColor * poiLight.finalLighting;
				poiFragData.finalColor += poiLight.finalLightAdd;
				float3 furRimInvLighting = saturate((1.0 - poiLight.directColor) * sqrt(poiLight.directColor));
				float furRimAntiLightValue = lerp(1, dot(furRimInvLighting, float3(1.0/3.0, 1.0/3.0, 1.0/3.0)), _FurRimAntiLight);
				poiFragData.finalColor += i.furLayer * pow((1 - abs(dot(normalize(i.normal), poiCam.viewDir))), _FurRimFresnelPower) * furRimAntiLightValue * _FurRimColor.rgb * poiLight.directColor;
				#if defined(POI_PASS_ADD) && !defined(LIL_FUR_PRE)
				if (_FurRenderingMode == 1)
				{
					poiFragData.finalColor.rgb *= saturate(poiFragData.alpha * _AlphaBoostFA);
				}
				#endif
				#ifndef POI_PASS_LILFUR
				#if !defined(POI_PASS_BASETWO) && !defined(POI_PASS_ADDTWO)
				...
				#endif
				#if defined(LIL_FUR_PRE)
				poiFragData.alpha = saturate(poiFragData.alpha * 5.0 - 2.0);
				if (poiFragData.alpha == 0) discard;
				#else
				if (_FurRenderingMode == 0)
				{
					poiFragData.alpha = saturate(poiFragData.alpha * 5.0 - 2.0);
				...
				#endif
				poiFragData.finalColor += poiFragData.emission;
				applyUnityFog(poiFragData.finalColor, i.fogData);
				#ifndef POI_PASS_LILFUR
				#if !defined(POI_PASS_BASETWO) && !defined(POI_PASS_ADDTWO)
				poiFragData.alpha = _AlphaForceOpaque ? 1 : poiFragData.alpha;
